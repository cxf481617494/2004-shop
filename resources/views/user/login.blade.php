                ...
                <div class="tab-content tab-wraped">
                    ...
                    <div id="profile" class="tab-pane  active">
                        ...
                        <div class="otherlogin">
                            <div class="types">
{{--                                <ul>--}}
{{--                                    <li><a href="{{$login_url}}"><img src="/img/qq.png" width="35px" height="35px" /></a></li>--}}
{{--                                    <li><a href="{{$login_url}}"><img src="/img/sina.png" /></a></li>--}}
{{--                                    <li><a href="{{$login_url}}"><img src="/img/ali.png" /></a></li>--}}
